...
class _ForgotPassword01WidgetState extends State<ForgotPassword01Widget> {
  ...
  void initState() {
    ...
    _model.forgotEmailAddressController ??= TextEditingController();
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  width: double.infinity,
                  child: TextFormField(
                    controller: _model.forgotEmailAddressController,
                    ...
                    validator: _model.forgotEmailAddressControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.forgotEmailAddressController.text.isEmpty) {
                      ...
                      await authManager.resetPassword(
                        email: _model.forgotEmailAddressController.text,
                        context: context,
                      );
                    },
                    text: 'Send Link',
